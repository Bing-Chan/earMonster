...
// import CodeMirror  from  'codemirror';a
...
// 				// 处理@相关内容
// 				const fieldKeywordArray = localStorage.codemirrorFieldList ? JSON.parse(localStorage.codemirrorFieldList) : [];
...
// 				// 处理#相关内容
// 				const keywordFunctionArray = localStorage.codemirrorMethodList ? JSON.parse(localStorage.codemirrorMethodList) : [];
...
// 				// 处理自定义无需校验的关键词
// 				const defineNormalList = localStorage.codemirrorNormalList ? JSON.parse(localStorage.codemirrorNormalList) : [];
...
// 	CodeMirror.defineMode('text/x-defineScript', 'defineScript');
// };

// export default initFormula;
