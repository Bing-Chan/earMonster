		...
		<div class="content_list">
			...
			<div class="table_list">
				<el-table :data="tableData" stripe border style="width: 100%" height="100%">
					...
					<el-table-column min-width="100px" show-overflow-tooltip prop="monthSalaryStructure" label="启用维度" align="center"></el-table-column>
					<el-table-column min-width="200px" prop="dailySalaryStructure" label="薪资项" align="center"></el-table-column>
					<el-table-column min-width="100px" prop="effectiveStartTime" label="生效日期" align="center">
						<template #default="scope">
...
export default defineComponent({
	...
	setup(props) {
		...
		const addOrEdit = async (row: any, isView) => {
			let id = '',
				path = '/salaryStandard/add';
			if (row) {
				path = '/salaryStandard/edit';
				id = row.id;
			}
			if (isView) {
				path = '/salaryStandard/view';
			}
			router.push({
				path: path,
				query: {
