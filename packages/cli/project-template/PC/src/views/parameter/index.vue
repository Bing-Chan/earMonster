  ...
  <div id="pages">
    ...
    <div>
      <div v-if="activeName == 1">
        <param-oper ref="paramOperRef"></param-oper>
      </div>
      <div class="" v-else>
        <param-no-oper ref="paramNoOperRef"></param-no-oper>
      </div>
    </div>
  </div>
</template>
...
import paramOper from './src/param-oper.vue';
import paramNoOper from './src/param-noOper.vue'
...
export default defineComponent({
    ...
    const changeTabs = () => {
      if(Object.is(state.activeName,1)){
        console.log(paramOperRef)
        paramOperRef.value.getList()
      }
    }
