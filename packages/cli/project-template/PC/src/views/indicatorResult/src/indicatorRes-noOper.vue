	...
	<div>
		<div class="query_box">
			<el-form :inline="true" label-position="left" :model="queryForm" ref="queryRef">
				...
				<!-- <el-form-item label="考核对象" prop="quotaDataDimensionType">
				...
				<el-form-item label="数据来源" prop="dataSource">
					<el-input style="width: 100%" v-model.trim="queryForm.dataSource" clearable placeholder="请输入数据来源"></el-input>
				</el-form-item>
				<el-form-item>
		...
		<div class="content_list">
			...
			<div class="table_list table_fixed">
				<el-table :data="tableData" stripe @selection-change="handleSelectionChange" border style="width: 100%">
					...
					<el-table-column prop="quotaName" fixed min-width="150" label="指标名称" align="center"></el-table-column>

					<el-table-column prop="baseVal" label="基础值" width="80" align="center">
						<template #default="scope">{{ !scope.row.baseVal ? '-' : scope.row.baseVal }} </template>
					</el-table-column>
					<el-table-column prop="targetVal" label="目标值" width="80" align="center">
						<template #default="scope">{{ !scope.row.targetVal ? '-' : scope.row.targetVal }} </template>
					</el-table-column>
					<el-table-column prop="realityVal" label="实际值" width="80" align="center"></el-table-column>
					<!-- <el-table-column prop="annTitle" label="具体数值" align="center">
						<template #default="scope">
							<el-button type="text" @click="handleConfig">{{ scope.row.annTitle }}</el-button>
						</template>
					</el-table-column> -->
					...
					<el-table-column prop="dataSource" min-width="450" label="数据来源" align="center"></el-table-column>
			...
			<el-row :gutter="35">
				<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
					<el-form ref="formRef" :model="editForm" :rules="formRules" label-position="right" label-width="150px">
						<el-form-item label="指标名称" prop="quotaName">
							<search :is-cao-zuo="false" @change="handleZhibiaoChange" :control-type="SearchEnum.ZHIBIAO" v-model="editForm.quotaName"></search>
						</el-form-item>
		...
		<import-file ref="importRef" type="indicatorResult" :jobType="2" :title="'指标数据'" @complete="handleComplete"></import-file>
	</div>
</template>
<script lang="ts">
	...
	setup(props) {
		...
		const state = reactive({
			...
			formRules: {
				...
				dimensionName: [{ required: true, message: '请选择考核对象代码', trigger: 'change' }],
			},
		});
