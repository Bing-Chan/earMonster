	...
	<div>
		<div class="query_box">
			<el-form :inline="true" label-position="left" :model="queryForm" ref="queryRef">
				...
				<!-- <el-form-item label="考核对象" prop="paramDataDimensionType">
		...
		<div class="content_list">
			...
			<div class="table_list table_fixed">
				<el-table :data="tableData" stripe @selection-change="handleSelectionChange" border style="width: 100%">
					...
					<el-table-column prop="realityValStr" label="实际值" width="80" align="center"></el-table-column>
			...
			<el-row :gutter="35">
				<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
					<el-form ref="formRef" :model="editForm" :rules="formRules" label-position="right" label-width="150px">
						<el-form-item label="参数名称" prop="paramName">
							<search @change="handleZhibiaoChange" :isCaoZuo="false" :control-type="SearchEnum.PARAM" v-model="editForm.paramName"></search>
						</el-form-item>
		...
		<import-file ref="importRef" :jobType="2" type="parameterResult" :title="'参数数据'" @complete="handleComplete"></import-file>
	</div>
</template>
<script lang="ts">
...
export default defineComponent({
	...
	setup(props) {
		const { useDictionaryList } = useDictionary(['sys_data', 'sys_time', 'sys_unit', 'sys_time']);
