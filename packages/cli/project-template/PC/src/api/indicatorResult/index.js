...
exports.AddType = exports.getModelInfo = exports.exportFail = exports.uploadFile = exports.indicatorResultList = exports.indicatorDownTemplete = exports.indicatorExport = exports.indicatorResultDisable = exports.indicatorResultInfo = exports.indicatorResultUpdate = exports.indicatorResultAdd = exports.getNoticeList = void 0;
            ...
            data: {
                ...
                resultData: [
                    ...
                    },
                    {
                        annTitle: '大范德萨发生的发',
                        annCategoryId: 1,
                        annContent: '<p>东方闪电开发及肯德基发了家里肯定就发ll</p><p>地方叫啥会计法接口了打飞机来看待结案快疯了的接口劳动法j<img src="http://10.130.136.139:9005/hrplatform/file/downLoadGetUrlNoAuth?filePath=group2/M00/00/1F/CoIk6WJD88CIfCslAAgcj7siKBgAAACugCRPwwACByn783.jpg" contenteditable="false" style="font-size: 14px; max-width: 100%;"/></p>',
                        publishStatus: true,
                        hrAnnAttachmentReq: null,
                        userVo: null,
                        annId: 11,
 ...
 * @returns
 */
function indicatorResultAdd(params) {
    return vue3_sdk_1.YtoHttp.post('quotaResult/add', params);
}
exports.indicatorResultAdd = indicatorResultAdd;
/**
 * @description 修改
 * @returns
 */
function indicatorResultUpdate(params) {
    return vue3_sdk_1.YtoHttp.post('quotaResult/update', params);
}
exports.indicatorResultUpdate = indicatorResultUpdate;
/**
 * @description 详情
 * @returns
 */
function indicatorResultInfo(params) {
    return vue3_sdk_1.YtoHttp.post('quotaResult/display', params);
}
exports.indicatorResultInfo = indicatorResultInfo;
/**
 * @description 启用/禁用
 * @returns
 */
function indicatorResultDisable(params) {
    return vue3_sdk_1.YtoHttp.post('quotaResult/disable', params);
}
exports.indicatorResultDisable = indicatorResultDisable;
/**
 * @description 导出
 * @returns
 */
function indicatorExport(params) {
    return vue3_sdk_1.YtoHttp.post('quotaResult/export', params, { responseType: 'blob' });
}
...
function indicatorDownTemplete(params) {
    return vue3_sdk_1.YtoHttp.post('quotaResult/template/down', params, { responseType: 'blob' });
}
 ...
 * @returns
 */
function indicatorResultList(params) {
    return vue3_sdk_1.YtoHttp.post('quotaResult/list', params);
}
exports.indicatorResultList = indicatorResultList;
/**
 * @description 列表
 * @returns
 */
function uploadFile(params) {
    return vue3_sdk_1.YtoHttp.post('quotaResult/import', params);
}
...
function exportFail(params) {
    return vue3_sdk_1.YtoHttp.post('quotaResult/import/downFailData', params, { responseType: 'blob' });
}
