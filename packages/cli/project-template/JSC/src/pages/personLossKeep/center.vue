...
export default {
  ...
  created() {
    // if (this.needUpdateType == '2') {
    //   this.selectHandle2({ value: '2' })
    //   this.height = 40
    // }
  ...
  beforeRouteEnter(to, from, next) {
    if (from.path === '/personLossKeep/first' || from.path === '/personLossKeep/orglevel3') {
