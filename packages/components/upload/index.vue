...
<script>
import language from '@ear-monster/utils/language'
import mimes  from '@ear-monster/utils/mimes' 
import data2blob   from '@ear-monster/utils/data2blob' 
import effectRipple from '@ear-monster/utils/effectRipple'
...
export default {
	...
	methods: {
		...
		upload() {
			let that = this,
				{ lang, imgFormat, mime, url, params, field, ki, createImgUrl, withCredentials, method } = this,
				fmData = new FormData()
